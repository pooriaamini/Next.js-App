...
function CardShow({ item }: { item: CardItems }) {
  return (
    <div className="flex flex-col items-center justify-center text-center gap-3 px-8 ">
      ...
      <p className="font-bold text-[1.2rem] xl:text-[1.5rem] dark:text-white ">
        {" "}
        {item.subject}
      </p>
      <p className="text-[#637381] dark:text-[#b5b3bc] text-[1rem]">
        {item.text}
      </p>
    </div>
  );
