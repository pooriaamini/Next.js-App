...
export default function Navbar({darkMode,setDarkMode}) {
  ...
  return (
    <nav
      className='navigation  flex items-center justify-between px-4 lg:px-0 lg:justify-around py-4 z-50'
    >
      <Link href="">
        <Image src={darkMode? logohidden : logo} width={150} height={150} alt="header logo" />
      </Link>
      ...
      <ul className=" hidden lg:flex list  gap-[3rem] text-[1.05rem] font-middle text-[#637381] dark:text-white ">
        ...
        <div onMouseEnter={handleHover} className="relative">
          ...
          <div
            ...
            className={`${
              isHover ? "fade-in" : "hidden"
            }         flex flex-col gap-4 bg-white dark:bg-black dark:text-white text-[1rem] text-black absolute rounded-2xl shadow-lg px-6 py-5 w-[15rem]  top-[3rem] left-[50%] translate-x-[-50%] z-10  `}
          >
      ...
      <div className="flex justify-normal items-center gap-4">
        ...
        <Link
          href=""
          className=" hidden md:block  Sign-btn bg-transparent border border-solid py-2 px-8 text-[#637381] border-[#637381] dark:text-white  rounded-full "
        >
          Sign In
        </Link>
        <Image
